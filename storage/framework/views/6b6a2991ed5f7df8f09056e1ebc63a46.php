              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form action="<?php echo e(route('register')); ?>" method="post">
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-danger">login</a>                  </div>
...
<?php /**PATH C:\xampp\htdocs\certificados\resources\views/auth/register.blade.php ENDPATH**/ ?>