...
<div class="position-relative form-group">
          ...
          <!--return false;  method="POST" action="<?php echo e(route('word')); ?>"-->
...
function Seleccionar_Plantilla(){
  ...
  location.href = "<?php echo e(route('excel_Documentos')); ?>?idPlantillas="+idPlantillas;
}
    ...
    var data = g_excel.getData();
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                ajax_data = {
                    ...
                    $.ajax({
                                    type: "POST",
                                    url: "<?php echo e(route('excel_Grabar_Documentos')); ?>",
                                    data: ajax_data,
                                    dataType: "json",
                                    beforeSend: function(){
                                    ...
                                    success: function(data){
                                        ...
                                        tabla_documentos(data.toString());
                                    }
                 });
                }else{
...
function tabla_documentos(iddoc='999999999999999999999'){
    ajax_data = {
    "idPlantillas" : $("#idPlantillas").val(),
    "iddoc"  : iddoc, 
    "alt"    : Math.random()
...
<?php echo $__env->make('layout_especialista/cuerpo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\certificados\resources\views/Excel_Documentos/excel_Documentos.blade.php ENDPATH**/ ?>