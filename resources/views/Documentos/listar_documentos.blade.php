...
<div class="main-card mb-12 card">
    <div class="card-body"><h5 class="card-title" style="font-size:20px;"><b>DOCUMENTOS</b>
        ...
        <div class="position-relative form-group">
          ...
          <!--return false;-->
        <form id="formulario" style="max-width:800px;" onsubmit="grabar_documentos();" method="POST" action="{{route('word')}}" enctype="multipart/form-data">
            <div class="row">
...
function Seleccionar_Plantilla(){
  ...
  location.href = "{{route('listar_documentos')}}?idPlantillas="+idPlantillas;
}
